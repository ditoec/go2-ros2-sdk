...
|---|---|---|---|
| A1 | Audit konfigurasi awal + setup ROS2 workspace | ✅ | Full ROS2 (Humble) workspace, `colcon build`. See [CLAUDE.md](CLAUDE.md), [docs/architecture.md](docs/architecture.md) |
